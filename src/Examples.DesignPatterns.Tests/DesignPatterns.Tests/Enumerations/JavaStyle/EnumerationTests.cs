namespace Examples.Enumerations.JavaStyle;
...
public partial class EnumerationTests
{
    ...
    [Theory]
    [MemberData(nameof(DatasOfNotEqualObjects))]
    ...
    public static readonly TheoryData<CardType?, CardType?, string> DatasOfNotEqualObjects = new()
    {
        {
            null,
            CardType.Amex,
