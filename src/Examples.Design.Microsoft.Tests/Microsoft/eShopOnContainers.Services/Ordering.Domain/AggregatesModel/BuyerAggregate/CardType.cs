...
namespace Microsoft.eShopOnContainers.Services.Ordering.Domain.AggregatesModel.BuyerAggregate
{
    ...
    public class CardType
        : Enumeration
    {
        public readonly static CardType Amex = new CardType(1, "Amex");
        public readonly static CardType Visa = new CardType(2, "Visa");
        public readonly static CardType MasterCard = new CardType(3, "MasterCard");
