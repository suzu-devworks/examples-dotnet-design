# Examples.Designs.Anderson.Tests
...
## Examples.Designs.Anderson.Tests
dotnet new xunit3 -o src/Examples.Designs.Anderson.Tests
dotnet sln add src/Examples.Designs.Anderson.Tests/
cd src/Examples.Designs.Anderson.Tests
