...
- Keep namespaces and folder structure aligned with project boundaries (`Examples.Design.*`).
...
- Model behavior through entities, value objects, aggregates, domain services, and repositories when they clarify the example.
- Keep invariants in the domain model rather than in scattered test setup.
- Use the ubiquitous language of the scenario or pattern being studied.
- Keep examples small and isolated so the domain concept stays easy to follow.
- Prefer explicit dependencies and simple test doubles over framework-heavy abstractions.
...
Test guidance (naming, test data, and environment assumptions) has been moved to
