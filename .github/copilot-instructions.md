...
- Prefer educational, scenario-driven examples over production-oriented infrastructure.
- Most implementation work lives under `src/Examples.Design.*.Tests`, and the solution is organized around test projects rather than runtime apps.
- See [README](../README.md) for the repository purpose and learning scope.
...
- Before implementation in an unfamiliar DDD area: [`.github/copilot/repository-context.md`](./copilot/repository-context.md)
- Before adding or modifying tests or test data: [`.github/copilot/tests-and-assets.md`](./copilot/tests-and-assets.md)
